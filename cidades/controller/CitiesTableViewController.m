...
//    self.fbLoginButton.backgroundColor = [UIColor purpleColor];
...
-(void)locationManager:(CLLocationManager *)manager didUpdateLocations:(NSArray *)locations {
    ...
    CLLocation * lastLocation = (CLLocation *) [locations lastObject];
     ...
     GMSCameraPosition * cameraPosition = [GMSCameraPosition cameraWithLatitude:lastLocation.coordinate.latitude longitude:lastLocation.coordinate.longitude zoom:10];
    ...
    self.marker.position = lastLocation.coordinate ;
